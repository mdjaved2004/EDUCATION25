	...
	<main>
		<form action="<%= request.getContextPath() %>/viewPages/user-view-pages/calculator-view-pages/quadrilateral-solve" method="post">
			<div class="form-group">
				<label for="quadriated_width_input" class="lable">Enter quadrilateral width: </label>
				<input type="number" 	id="quadriated_width_input" name="quadriated_width_input"
					...
					max='1500' required>
				<div class="form-group">
					<label for="operator" class="lable">Choose operator: </label> 
				...
				<label for="quadriated_height_input" class="lable">Enter quadrilateral height: </label> 
