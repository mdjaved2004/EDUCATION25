...
public interface QuestionPaperAddOneQuetionService {
	String addOneQuestionService(QuestionPaperQuestionDataModel questionInformationModel, String paper_name); 
}