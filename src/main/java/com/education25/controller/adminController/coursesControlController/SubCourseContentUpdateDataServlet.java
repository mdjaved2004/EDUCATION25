...
@WebServlet("/viewPages/admin-view-pages/control-courses-view-pages/sub-course-content-update-data")
public class SubCourseContentUpdateDataServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String subCourseName=null, sortId=null, pageRedirect=null;
	    ...
	    if(subCourseFullInformationModel.getMessage_error()!=null) {
		    ...
		    pageRedirect = "/viewPages/admin-view-pages/control-courses-view-pages/sub-course-content-update.jsp";
