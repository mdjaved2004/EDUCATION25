...
import com.education25.service.userService.authService.ForgetPasswordService;
import com.education25.service.userService.authService.ForgetPasswordServiceImpl;

@WebServlet("/viewPages/user-view-pages/auth-view-pages/forget-password")
public class ForgetPasswordMailServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(user_email==null) {
			...
			RequestDispatcher rd = request.getRequestDispatcher("/viewPages/user-view-pages/auth-view-pages/forget-password.jsp");
